...
CREATE TABLE `ACTIVITYS` (
  ...
  CONSTRAINT `ACTIVITYS_ibfk_1` FOREIGN KEY (`TASK_ID`) REFERENCES `TASKS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `ACTIVITYS_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
...
CREATE TABLE `COMMENTS_ACTIVITY` (
  ...
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `COMMENTS_ACTIVITY_ibfk_1` FOREIGN KEY (`ACTIVITY_ID`) REFERENCES `ACTIVITYS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `COMMENTS_ACTIVITY_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `COMMENTS_JOB_POST` (
  ...
  KEY `POST_ID` (`POST_ID`),
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `COMMENTS_JOB_POST_ibfk_1` FOREIGN KEY (`POST_ID`) REFERENCES `POST_JOB` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `COMMENTS_JOB_POST_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
...
CREATE TABLE `COMMENTS_TASK_POST` (
  ...
  KEY `POST_ID` (`POST_ID`),
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `COMMENTS_TASK_ibfk_1` FOREIGN KEY (`POST_ID`) REFERENCES `POST_TASKS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `COMMENTS_TASK_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `COMMENT_NOTICES` (
  ...
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `COMMENT_NOTICES_ibfk_1` FOREIGN KEY (`NOTICE_ID`) REFERENCES `NOTICES` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `COMMENT_NOTICES_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
...
CREATE TABLE `JOBS` (
  ...
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `JOBS_ibfk_1` FOREIGN KEY (`PROJECT_ID`) REFERENCES `PROJECTS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `JOBS_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
...
CREATE TABLE `NOTICES` (
  ...
  KEY `PROJECT_ID` (`PROJECT_ID`),
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `NOTICES_ibfk_1` FOREIGN KEY (`PROJECT_ID`) REFERENCES `PROJECTS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `NOTICES_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
...
CREATE TABLE `POST_JOB` (
  ...
  KEY `JOB_ID` (`JOB_ID`),
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `POST_JOB_ibfk_1` FOREIGN KEY (`JOB_ID`) REFERENCES `JOBS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `POST_JOB_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `POST_TASK` (
  ...
  KEY `TASK_ID` (`TASK_ID`),
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `POST_TASK_ibfk_1` FOREIGN KEY (`TASK_ID`) REFERENCES `TASKS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `POST_TASK_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TASKS` (
  ...
  KEY `JOB_ID` (`JOB_ID`),
  KEY `AUTHOR_ID` (`AUTHOR_ID`),
  CONSTRAINT `TASKS_ibfk_1` FOREIGN KEY (`JOB_ID`) REFERENCES `JOBS` (`ID`) on delete cascade on update cascade ,
  CONSTRAINT `TASKS_ibfk_2` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `USERS` (`ID`) on delete cascade on update cascade 
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
